...
function random() {
	...
	this.run = function() {
		...
		for (i in this.list) {
			...
			title += '<div class="randomItem">' + this.list[i].name[len - 1].name + '</div>';
			for (j in this.list[i].name) {

				title += '<div class="randomItem">' + this.list[i].name[j].name + '</div>';

			}
			title += '<div class="randomItem">' + this.list[i].name[0].name + '</div>';

			html += '<div class="randomMenu">' + '<div class="randomTitle">' + this.list[i].tag + '</div>' + '<div class="randomItemList">' + '<div class="randTopShadow"></div>' + '<div class="randomItemScrollBox" index="' + i + '">' + title + '</div>' + '<div class="randBottomShadow"></div>' + '</div>' + '<div class="randomResult">' + '結果' + '</div>' + '<div class="randomCheckBox">' + '<div class="randomCheckBtn" index="' + i + '">' + '確定' + '</div>' + '</div>' + '</div>';
